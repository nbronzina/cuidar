# Instituciones — Cuidados en Red

Fuente de verdad para todas las instituciones mencionadas en el sitio. Antes de nombrar cualquier institución, verificar aquí.

## Usar siempre

| Institución | Descripción | Notas |
|---|---|---|
| **ObSBA** | Obra Social de la Ciudad de Buenos Aires | Obra social de empleados y jubilados del GCBA. Es la cobertura de salud de las personas cuidadoras del sistema. |
| **PAMI** | Obra social de jubilados nacionales | Programa de Atención Médica Integral. Referencia para comparaciones de cobertura. |
| **ANSES** | Jubilaciones y pensiones | Administración Nacional de la Seguridad Social. |
...
| **Dirección de Cuidados Horizontales** | Órgano de gobierno del sistema (ficticio) | Creada en 2029 dentro del GCBA. |
...
| **Galeno** | Prepaga comercial. |
| **Cualquier prepaga comercial** | El sistema es público y no involucra prepagas. |
| **Nombres de ministerios actuales** | Cambian con cada gobierno. Evitar nombres específicos de ministerios salvo "Ministerio de Desarrollo Humano y Hábitat" que aparece en la resolución ficticia. |
| **Isologo "BA"** | Asociado al PRO, partidario. Usar siempre el escudo heráldico de la Ciudad. |

## Leyes y normativa referenciada
...
|---|---|---|
| Índice de Barthel | Real | Evaluación de dependencia funcional. Determina nivel de cuidado. |
| Mini Examen Cognitivo (MEC) | Real | Screening cognitivo. Complementa Barthel para asignación de nivel. |
